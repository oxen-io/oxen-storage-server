...
template <>
struct hash<oxen::legacy_pubkey> : hash<oxen::legacy_pubkey::PubKeyBase> {};
template <>
struct hash<oxen::x25519_pubkey> : hash<oxen::x25519_pubkey::PubKeyBase> {};
template <>
struct hash<oxen::ed25519_pubkey> : hash<oxen::ed25519_pubkey::PubKeyBase> {};
